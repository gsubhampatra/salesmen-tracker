...
export const getDistributorAnalytics = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_DISTRIBUTOR_ANALYTICS);
}
...
export const getAverageVisitDuration = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_AVERAGE_VISIT_DURATION);
}

export const getMaxDistanceTraveled = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_MAX_DISTANCE_TRAVELED);
}
...
export const getVisitsPerDistributor = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_VISITS_PER_DISTRIBUTOR);
}

export const getMostActiveSalesman = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_MOST_ACTIVE_SALESMAN);
}

export const getDistributorWithNoVisits = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_DISTRIBUTOR_WITH_NO_VISITS);
}
...
export const getSalesmanProductivity = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_SALESMAN_PRODUCTIVITY);
}

export const getAvgVisitDurationOvertime = async () => {
  return await api.get(API_PATHS.DASHBOARD.DISTRIBUTOR.GET_AVG_VISIT_DURATION_OVERTIME);
}

// Detailed Analytics Routes
export const getTotalSalesmen = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_TOTAL_SALESMEN);
}

export const getTotalLocationsManaged = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_TOTAL_LOCATIONS_MANAGED);
}

export const getTotalVisitsMade = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_TOTAL_VISITS_MADE);
}

export const getOverallaccuracy = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_OVERALL_ACCURACY);
}

export const getPeakVisitingHour = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_PEAK_VISITING_HOURS);
}

export const getMostVisitedLocations = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_MOST_VISITED_LOCATIONS);
}

export const getMostVisitedLocation = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_MOST_VISITED_LOCATION);
}

export const getAverageVisitDurations = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_AVERAGE_VISIT_DURATION);
}

export const getRegionWiseSalesmen = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_REGION_WISE_SALESMEN);
}

export const getStateWiseVisitDistribution = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_STATE_WISE_VISIT_DISTRIBUTION);
}

export const gettotalOutletsAssigned = async () => {
  return await api.get(API_PATHS.DASHBOARD.DETAILED_ANALYTICS.GET_TOTAL_OUTLETS_ASSIGNED);
}
...
export const getSalesmanSummary = async () => {
  return await api.get(API_PATHS.DASHBOARD.SALESMAN_SUMMARY.GET_SALESMAN_SUMMARY);
}
